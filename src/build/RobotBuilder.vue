<template>
    <div class="content">
        <div class="preview">
          ...
          <button class="add-to-cart" @click="addToCart()">Agregar al Carro de Compras</button>
        </div>
        
        <div class="top-row">
            <!-- <div class="top part" :style="[headBorderStyle, moreStyles]"> Es cuando usamos multiples "computed" -->
            <!-- <div class="top part" :style="headBorderStyle"> Es cuando usamos simple bind de una "computed Property" -->
            <!-- <div class="top part" :class="{'sale-border': selectedRobot.head.onSale}"> Usar el Bind de class -->
...
/* function getPreviousValidIndex(index, length) {
  ...
  return deprecatedIndex < 0 ? legth - 1 : deprecatedIndex;
}

function getNextValidIndex(index, length) {
  const incrementIndex = index + 1;
  return incrementIndex < 0 ? legth - 1 : incrementIndex;
} */
    ...
    computed: {
      ...
      /* selectedRobot() {
        return {
          ...
          rigth: availableParts.arms[this.selectedRightArmIndex],
